...
public class FacturaConsumoValidator extends ComprobanteValidatorGeneric {


    protected static final BigDecimal UMBRAL_MONTO_MINIMO = new BigDecimal("250000.00");
